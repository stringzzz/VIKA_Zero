...
const unsigned int NTEST_KEYS = 20000; //Takes approx. 40min //FLAG
...
int main(int argc, char *argv[]) {
	...
	double difference_distribution[total_ks_bits + 1];
	for(unsigned int n = 0; n <= total_ks_bits; n++) {
	...
	//FLAG
	std::ofstream keyschedule_file2(output_filename, std::ios::out);

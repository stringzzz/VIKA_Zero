...
void VIKA_Zero_CandidateA::setKeyH(std::string hex_string) {
	...
	if (std::regex_search(hex_string, std::regex("[^a-fA-F0-9]"))) {
		throw VIKA_Zero_CandidateA_Exception("VIKA_Zero_CandidateA: Key as hex string must contain only valid hexadecimal digits.");   
	}

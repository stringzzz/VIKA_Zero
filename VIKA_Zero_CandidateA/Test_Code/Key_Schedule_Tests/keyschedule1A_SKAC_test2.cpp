/*
    This is part of the VIKA_Zero_CandidateA encryption system tests, the source code file for testing the keyschedule 1A Key Avalanche Effect
    ...
    for(unsigned int n_shuffles = 0; n_shuffles < 1; n_shuffles++) {
        for(unsigned int n_cycles_per_pbox = 0; n_cycles_per_pbox < 1; n_cycles_per_pbox++) {
            for(unsigned int n_cycles = 0; n_cycles < 1; n_cycles++) {
                ...
                //FLAG
                std::ofstream keyschedule_file2("keyschedule1A_SKAC_test2_final2.txt", std::ios::app);
                ...
                std::ofstream keyschedule_file3("keyschedule1A_SKAC_test2_distribution_final2.txt", std::ios::app);

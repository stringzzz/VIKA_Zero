/*
    This is part of the VIKA_Zero_CandidateA encryption system tests, the source code file for testing the P-Box and encryption setup 4C
    ...
    for(unsigned int n_shuffles = 0; n_shuffles < 6; n_shuffles++) {
        ...
        for(unsigned int n_cycles_per_pbox = 0; n_cycles_per_pbox < 1; n_cycles_per_pbox++) {
            for(unsigned int n_cycles = 0; n_cycles < 1; n_cycles++) {
                ...
                //FLAG
                std::ofstream pbox_file("pbox_test4C_1000x1000.txt", std::ios::app);

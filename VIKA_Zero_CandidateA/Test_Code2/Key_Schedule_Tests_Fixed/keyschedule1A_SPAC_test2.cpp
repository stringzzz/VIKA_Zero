...
int main(int argc, char *argv[]) {
    ...
    //FLAG
    std::ofstream keyschedule_file("keyschedule1A_SPAC_test2_2000x3500_final_fixed.txt", std::ios::app);
    ...
    std::ofstream keyschedule_file2("keyschedule1A_SPAC_test2_distribution_final_fixed.txt", std::ios::app);
